...
Puppet::ResourceApi.register_type(
  ...
  attributes:   {
    ...
    connections:          {
      type:      "Array[Struct[{Optional[port] => Integer[0, 65535], Optional[snmp_community_string] => String, Optional[ssh_password] => String, Optional[username] => String, address => String[1,255], connect_method => Enum['SSH','SNMPv2c'], }]]",
